                ...
                <div class="container">
                    ...
                    <div class="view-more">
                                ...
                                if( $series_button ): 
                                    ...
                                    ?>
                                    <a class="schedule" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"  data-aos="fade-in" data-aos-duration="500" data-aos-delay="500"><?php echo esc_html( $link_title ); ?> <img src="<?php echo ipo_arrow_icon_url(); ?>" alt=""></a>
                                <?php endif; ?>
            </div>
                </div><!-- /.container -->
