<?php 
/*
* Template Name: Gneral Information Page
*/
  ...
  <div class="container">
    ...
    <div class=" col-md-4 col-sm-4 col-xs-12 sidebar_mobile">
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title"> <a href="<?php echo home_url().'/the-band'; ?>">
               <?php if(ICL_LANGUAGE_CODE=='en'){ ?>
      ...
      <div class=" col-md-4 col-sm-4 col-xs-12 sidebar_desktop">
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title"> <a class="collapsed" href="<?php echo home_url().'/orckestrateam'; ?>">
               <?php if(ICL_LANGUAGE_CODE=='en'){ ?>
