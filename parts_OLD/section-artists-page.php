...
if($artists): ?>
    <section class="meet_area section-view">
        <div>
            ...
            <div class="container">
                <a class="schedule" href="#"  data-aos="fade-in" data-aos-duration="500" data-aos-delay="500">לכל חברי התזמורת<img src="/wp-content/uploads/2022/06/left-arrow.png" alt=""></a>
            </div>
