...
$wpstack_img = new wpstack_image($image,['size' => 'thumbnail']);
$musician_type = get_the_terms( $post_id, 'musician_type' );
$name = get_the_title($post_id);
$title = $musician_type[0]->name;

?>


<li class="orckestra loop-artist-team" data-aos="fade-in"  data-aos-duration="1000" data-aos-delay="200">
    <div class="media">
