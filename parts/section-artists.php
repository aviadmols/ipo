...
$meet_our_artists_str = 'הכירו את הנגנים שלנו';
// if wpml constant is EN
if(defined('ICL_LANGUAGE_CODE') && ICL_LANGUAGE_CODE == 'en'){
    $meet_our_artists_str = 'Meet our artists';
}
            ...
            <div class="container">
                <?php if($artists_title) : ?>
                 <h2 class="lette-sapce-10 ml10 animate-letters"><?php echo $artists_title;?></h2>
                  ...
                  <?php else: ?>
    <h2 class="lette-sapce-10 ml10 animate-letters"><?php echo $meet_our_artists_str; ?></h2>
                <?php endif;?>
            </div>
...
$delay = 200;
                    foreach($artists as $artist){
                        ...
                        if($image){
                            $image = wp_get_attachment_image($image, 'loop-artist-team-large');

                        }else{
                            $image = get_the_post_thumbnail($artist, 'loop-artist-team-large');
                        }
...
$delay = $delay + 50;
            ...
            <div class="container">
                <?php 
                    ...
                    ?>
                    <a class="schedule" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?> <img src="<?php echo ipo_arrow_icon_url(); ?>" alt=""></a>
                <?php endif; ?>
            </div>
