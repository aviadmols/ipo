...
<section class="video_area " data-aos="fade-in" data-aos-offset="0" data-aos-duration="0" >
  ...
  <div class="overlay-background" style="height: 100%;">
            ...
            <div class="container" style="position: relative; z-index: 2;">
                ...
                <div class="row justify-content-end">
                    <div class="col-12">
                        <div class="text animate_wow"  data-aos="fade-in" data-aos-duration="100" data-aos-delay="500">
                          <?php if ( $Titlevideo): ?>
                          <h2 class="lette-sapce-10 " style="color: #ffc5c5; line-height: 1.1;" >
