...
<?php if( have_rows('slider_banner_2') ): ?>

    <!-- Slider for desktop -->
    <div class="slider-banner desktop pt-100" data-aos="fade-up" data-aos-duration="750" >
        <?php while( have_rows('slider_banner_2') ): the_row();
