                    ...
                    <li>
                        ...
                        <div class="link">
                            ...
                            <?php if($podcast['audio_file']) : ?>
                                <a href="<?php echo $podcast['audio_file']['url'];?>">להשמעה  <span><img src="/wp-content/themes/wpstack-child/includes/images/others/play.svg" alt="Img" class="img-fluid"></span></a>
                            <?php endif;?>
